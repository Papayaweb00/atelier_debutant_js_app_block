let blogContent = [
    {
        "id": 1,
        "name": "Bienvenue dans mon nouveau blog",
    ...
    {
        "id": 2,
        "name": "Comment devenir un developpeur",
    ...
    //     "body": "maiores sed dolores similique labore et inventore etquasi temporibus esse sunt id eteos voluptatem aliquamaliquid ratione corporis molestiae mollitia quia et magnam dolor",
    //     "date": "25/12/2000"
    // },
    // {
    //     "id": 8,
    //     "name": "et omnis",
    //     "body": "ut voluptatem corrupti velitad voluptatem maioreset nisi velit vero accusamus maioresvoluptates quia aliquid ullam eaque",
    //     "date": "25/10/2020"
    // },
    // {
    //     "id": 9,
    //     "name": "provident id",
    //     "body": "sapiente assumenda molestiae atqueadipisci laborum distinctio aperiam et ab ut omniset occaecati aspernatur odit sit rem expeditaquas enim ipsam minus",
    //     "date": "1/9/2010"
    // },
    // {
    //     "id": 10,
    //     "name": "eaque et",
    //     "body": "voluptate iusto quis nobis reprehenderit ipsum amet nullaquia quas dolores velit et nonaut quia necessitatibusnostrum quaerat nulla et accusamus nisi facilis",
    //     "date": "20/12/2000"
    // }
]